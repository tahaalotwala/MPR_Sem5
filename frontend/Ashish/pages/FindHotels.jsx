  ...
  return (
    <>
      ...
      <div className="flex justify-center " style={{ height: "30rem" }}>
        <div
          className="Hotel-SearchBar border-spacing-0 "
      ...
      <div>
        <div className="flex justify-between px-[5rem] py-[1.5rem] items-center">
          <section className="nav-links flex gap-5">
            {cities.map((city) => {
              return (
                <button className="nav-link hover:text-gray-500" key={city}>
                  {city}
                </button>
              );
            })}
      ...
      <div>
        <ul
          role="list"
          className="divide-y divide-gray-100 flex justify-center flex-wrap"
        >
